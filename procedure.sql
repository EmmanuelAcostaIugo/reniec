CREATE OR REPLACE PROCEDURE IDOTABMAESTRA.SP_GET_DATOS_CIUDADANO (
...
BEGIN
    ...
    SELECT
        ...
        -- Domicilio concatenado con lógica de dominios
        ...
        NVL(TRIM(NVL(DECODE(R.DE_CEL, NULL, NULL,
            DECODE(INSTR(R.DE_CEL, '-'), 0, R.DE_CEL, SUBSTR(R.DE_CEL, INSTR(R.DE_CEL, '-') + 2))), ' ')),
    ...
    FROM
        ...
        LEFT JOIN IDOTABMAESTRA.GEVW_UBIGEOS U_NACI ON U_NACI.CO_DEPARTAMENTO = A.CO_DEPARTAMENTO_NACI AND U_NACI.CO_PROVINCIA = A.CO_PROVINCIA_NACI AND U_NACI.CO_DISTRITO = A.CO_DISTRITO_NACI AND U_NACI.CO_PAIS = A.CO_PAIS_NACI AND U_NACI.CO_CONTINENTE= A.CO_CONTINENTE_NACI AND U_NACI.CO_CENTRO_POBLADO_O = A.CO_CENTRO_POBLADO_NACI
        LEFT JOIN IDOTABMAESTRA.GEVW_UBIGEOS U_DOM ON U_DOM.CO_DEPARTAMENTO = A.CO_DEPARTAMENTO_DOMICILIO AND U_DOM.CO_PROVINCIA = A.CO_PROVINCIA_DOMICILIO AND U_DOM.CO_DISTRITO = A.CO_DISTRITO_DOMICILIO AND U_DOM.CO_PAIS = A.CO_PAIS_DOMICILIO AND U_DOM.CO_CONTINENTE = A.CO_CONTINENTE_DOMICILIO AND U_DOM.CO_CENTRO_POBLADO_O = A.CO_CENTRO_POBLADO_DOMICILIO
